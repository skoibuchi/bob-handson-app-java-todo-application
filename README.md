...
### 1. Bobウィンドウ上部`⋯`→モードから設定
各モード共通のカスタム指示が可能。

1. モードにて、編集するモードを指定
2. モード固有のカスタム指示にて、各モードにてAIに共通で指示する内容を記載

![モードルール設定](./images/bob-mode-instruction.png)
...
![Projectルール設定](./images/bob-project-instruction.png)
...
- [GitHub](https://github.ibm.com/banking-signatures-squad-2/bob-handson-app-java-todo-application.git)
...
![サンプルアプリ画面](./images/sample-java-app.png)
...
5. **実装が完了したら、動作確認を行います**  
   ...
   ![サンプルアプリ追加機能](./images/sample-java-app-enhanced.png)
...
4. **「Direct fix」を押すことで、Bobに修正をリクエストすることが可能です**

![Bob Findings](./images/bob-bob-findings.png)
